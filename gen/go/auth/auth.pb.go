...
type LoginRequest struct {
	...
	Email    string `protobuf:"bytes,1,opt,name=email,proto3" json:"email,omitempty"`              // Email of the user
	Password string `protobuf:"bytes,2,opt,name=password,proto3" json:"password,omitempty"`        // Password of the user
	AppId    string `protobuf:"bytes,3,opt,name=app_id,json=appId,proto3" json:"app_id,omitempty"` // UUID of the app that user is trying to log in to
}
...
type RegisterAppRequest struct {
	...
	AppSecret string `protobuf:"bytes,2,opt,name=app_secret,json=appSecret,proto3" json:"app_secret,omitempty"` // Secret key of the application
	AdminKey  string `protobuf:"bytes,3,opt,name=admin_key,json=adminKey,proto3" json:"admin_key,omitempty"`    // Key of the admin. Provides privilege to add a new application
}
...
func (x *RegisterAppRequest) GetAdminKey() string {
	if x != nil {
		return x.AdminKey
	}
	return ""
...
type RegisterAppResponse struct {
	...
	AppId string `protobuf:"bytes,1,opt,name=app_id,json=appId,proto3" json:"app_id,omitempty"` // UID of the application
}
...
var file_auth_auth_proto_rawDesc = []byte{
	...
	,
	...
	0x6e, 0x73, 0x65, 0x12, 0x43, 0x0a, 0x0b, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x41,
	0x70, 0x70, 0x12, 0x19, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74,
	0x65, 0x72, 0x41, 0x70, 0x70, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x1a, 0x19, 0x2e,
	0x61, 0x75, 0x74, 0x68, 0x2e, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x41, 0x70, 0x70,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x15, 0x5a, 0x13, 0x6c, 0x65, 0x73, 0x69,
	0x6f, 0x6e, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x76, 0x31, 0x3b, 0x61, 0x75, 0x74, 0x68, 0x62,
...
var file_auth_auth_proto_goTypes = []any{
	...
	(*RegisterAppRequest)(nil),  // 4: auth.RegisterAppRequest
	(*RegisterAppResponse)(nil), // 5: auth.RegisterAppResponse
}
var file_auth_auth_proto_depIdxs = []int32{
	0, // 0: auth.Auth.Register:input_type -> auth.RegisterRequest
	2, // 1: auth.Auth.Login:input_type -> auth.LoginRequest
	5, // 2: auth.Auth.RegisterApp:input_type -> auth.RegisterAppResponse
	1, // 3: auth.Auth.Register:output_type -> auth.RegisterResponse
	3, // 4: auth.Auth.Login:output_type -> auth.LoginResponse
	5, // 5: auth.Auth.RegisterApp:output_type -> auth.RegisterAppResponse
