...
type AuthClient interface {
	...
	RegisterApp(ctx context.Context, in *RegisterAppResponse, opts ...grpc.CallOption) (*RegisterAppResponse, error)
}
...
func (c *authClient) RegisterApp(ctx context.Context, in *RegisterAppResponse, opts ...grpc.CallOption) (*RegisterAppResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type AuthServer interface {
	...
	RegisterApp(context.Context, *RegisterAppResponse) (*RegisterAppResponse, error)
...
func (UnimplementedAuthServer) RegisterApp(context.Context, *RegisterAppResponse) (*RegisterAppResponse, error) {
...
func _Auth_RegisterApp_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).RegisterApp(ctx, req.(*RegisterAppResponse))
	}
	return interceptor(ctx, in, info, handler)
}
